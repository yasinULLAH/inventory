...
$app_url = 'https://myapp.gobuykar.com/';
function app_img($path) {
    global $app_url;
    if (empty($path)) return '';
    if (strpos($path, 'http') === 0 || strpos($path, 'data:') === 0) return $path;
...
$meta_image_url = (preg_match('/^https?:\/\//', $meta_image)) ? $meta_image : ($meta_image === 'logo.png' ? $base_url . '/' . ltrim($meta_image, '/') : app_img($meta_image));
?>
<!DOCTYPE html>
<html lang="en">
<head>
